...
public class best_selling_products_employee extends javax.swing.JFrame {

    public best_selling_products_employee() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(294, 0, 860, -1));
        ...
        jPanel1.add(sdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 150, 158, 30));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Enter the End Date ");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 160, -1, -1));
        jPanel1.add(enddate, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 150, 162, 30));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 220, 80, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 300, 574, 298));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        BestProductSellingReport salesAnalyzer = new BestProductSellingReport();
        salesAnalyzer.analyzeBestProductSales(sdate, enddate, btable);
    ...
    public class BestProductSellingReport extends best_selling_product {

        public void analyzeBestProductSales(JDateChooser sdate, JDateChooser enddate, JTable btable) {
            super.best_product_selling(sdate, enddate, btable);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(best_selling_products_employee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new best_selling_products_employee().setVisible(true);
            }
        });
    }
