 ...
 * @author FAZLAN
 */
public class customer_beharivor extends javax.swing.JFrame {

    /**
     * Creates new form customer_beharivor
     */
    public customer_beharivor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 180, -1, -1));
        jPanel1.add(txt_cid, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 180, 193, 33));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 240, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 310, 610, 282));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(289, 0, 680, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 240, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        customer_beharivor cbobj = new customer_beharivor();
        cbobj.customer_behavriour(txt_cid, customer_analysis_table);
   ...
   public void customer_behavriour(JTextField txt_cid, JTable customer_analysis_table) {
    try (Connection con = ObjectFactory.createDatabaseConnection()) { // Ensure database.getConnection() is defined
        ...
        String query = "SELECT region, product_name, SUM(qty) AS total_qty, priceperunit "
                + "FROM products "
                + "WHERE customer_id = ? "
                + "GROUP BY region, product_name, priceperunit "
        ...
        DefaultTableModel model = new DefaultTableModel(new String[]{"Region", "Product Name", "Total Spent"}, 0);
        ...
        while (rs.next()) {
            ...
            customer_analysis customerData = new customer_analysis(region, productName, totalSpent);

            // Add row to table model
            model.addRow(new Object[]{
                customerData.getRegion(),
                customerData.getProductName(),
                customerData.getTotalSpent()
            });
        }

        // Show message if no data found
        if (!dataFound) {
            JOptionPane.showMessageDialog(null, "No data found for the given customer ID.");
        }
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(null, "Invalid customer ID format. Please enter a numeric value.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customer_beharivor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new customer_beharivor().setVisible(true);
            }
        });
    }
