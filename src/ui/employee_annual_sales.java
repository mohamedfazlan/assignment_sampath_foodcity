...
public class employee_annual_sales extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //call the method to action button
        Annual_Sales_Performance annualsales = new Annual_Sales_Performance();
        annualsales.AnnualSales(txtyear, txttotal, product_table_1, customer_table_2);


    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        employee_view_product ed = new employee_view_product();
        this.dispose();
        ed.setVisible(true);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        employee_annual_sales as = new employee_annual_sales();
        this.dispose();
        as.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(employee_annual_sales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new employee_annual_sales().setVisible(true);
            }
        });
    }
